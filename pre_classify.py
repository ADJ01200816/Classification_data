...
# Used without dependence on other methods

def preprocess_function(examples):
    return tokenizer(examples["text"], padding="max_length", truncation=True)


# Input classification list and targets, calculate cosine similarity
...
def get_range(keyword:str)->list[int]:
    ...
    # Keyword clauses and attribute clauses computed
    if(E == "embedding"):
    ...
    # Keyword terms and attribute terms counted
    else:
        ...
        # (each keyword of keyword with [each attri_embedding counts cosine similarity] in an attribute,) summed as a result of attribute
        #key 【0】【1】【2】 attri 0[0][1][2] 1[0][1][2] 3[0][1][2] 
        # [0] [1] [2] with 0 [0] [1] [2] Calculated sum as a result
        ...
        # a keyword with all rows of all columns of embedding to calculate the cosine similarity, for each row of the sum, take the largest [10] attribute, for their weights +1
        #key 【0】【1】【2】 attri 0[0][1][2] 1[0][1][2] 3[0][1][2] 
        # [0] with 0[0][1][2] 1[0][1][2] 3[0][1][2] respectively, respectively, to get 0 res, 1 res, 2 res, on question_range[index of maxres]+1
...
def keyword_extraction_by_TF_IDF(text:str)->list[str]:
    ...
    # Create TF-IDF vectoriser and set parameters to extract only single words
...
def keyword_extraction_by_llm(text:str)->str:
    ps_info = "Please do not output any output other than keywords. \n"
